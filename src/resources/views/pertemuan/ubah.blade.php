...
<form method="POST" class="container bg-light p-3 mb-3 needs-validation" novalidate>
    ...
    <div class="row">
        <div class="col-sm-3 mb-3">
            ...
            <input type="number" class="form-control" value="{{ $pertemuan->urutan }}"
                id="pertemuan-ke" name="pertemuan-ke" placeholder="1" required>
        ...
        <div class="col-sm-6 mb-3">
            ...
            <select class="form-select" id="ruangan" name="ruangan" aria-label="Default select example">
                ...
                <option {{ $pertemuan->ruangan_id && $pertemuan->ruangan_id === $ruangan->ruangan_id ? 'selected' : '' }}
                    value="{{ $ruangan->ruangan_id }}">{{ $ruangan->kode }}</option>
                @endforeach
            </select>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-4 mb-3">
            ...
            <input value="{{ $pertemuan->tanggal }}" type="date" class="form-control" id="tanggal" name="tanggal" required>
            <div class="invalid-feedback">
        ...
        <div class="col-sm-4 mb-3">
            ...
            <input value="{{ date_format(new DateTime($pertemuan->jam_mulai), 'H:i') }}" type="text" class="form-control" id="jam-mulai" name="jam-mulai" required>
            <div class="invalid-feedback">
        ...
        <div class="col-sm-4 mb-3">
            ...
            <input value="{{ date_format(new DateTime($pertemuan->jam_selesai), 'H:i') }}" type="text" class="form-control" id="jam-selesai" name="jam-selesai" required>
            <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <textarea name="topik" id="topik" rows="5" class="form-control" required>{{ $pertemuan->topik_kuliah }}</textarea>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <textarea name="topik-en" id="topik-en" rows="5" class="form-control" required>{{ $pertemuan->topik_kuliah_en }}</textarea>
        <div class="invalid-feedback">
            Mohon masukkan topik perkuliahan (Bahasa Inggris)
        </div>
    </div>
    <div>
        <label for="jenis-perkuliahan" class="form-label fw-bolder">Jenis Perkuliahan</label>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="jenis-perkuliahan" id="online" value="D" required
            {{ $pertemuan->mode_pertemuan && $pertemuan->mode_pertemuan === 'D' ? 'checked' : '' }}>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="jenis-perkuliahan" id="offline" value="L"
            {{ $pertemuan->mode_pertemuan && $pertemuan->mode_pertemuan === 'L' ? 'checked' : '' }}>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="jenis-perkuliahan" id="hybrid" value="H"
            {{ $pertemuan->mode_pertemuan && $pertemuan->mode_pertemuan === 'H' ? 'checked' : '' }}>
